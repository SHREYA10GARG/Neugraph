...
function drawChart() 
{
 ...
 chart.draw(data, options);
        ...
        <style type="text/css">
                 ...
                 .info-text
          {
            ...
            #firstimage
            {
                ...
                background-image: url("logo final1200.PNG");
                border: 2px solid black
            }
            #maincontainer
            {
    ...
    <body>
						...
						<div class="tab-pane show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                            <div class="container">
                                ...
                                <div class="row">
                                            <div class="col-lg-6">
                                                <p class="info-text">
                                                   The database provides a description of herbal plants used in the treatment of neurological diseases and disorders. The database also presents the geographical distribution of the plants.

                                                </p>
                                                <p class="info-text">
                                                  The aim behind developing of this database is to enhance the knowledge of medicinal plants which are used in the treatment/ lowering down the symptoms of neurological diseases. This site contains text and photographs describing the essential characteristics of the plant species. NeuGraph provides a platform to apply our traditional knowledge for accelerating the therapeutics against several neurological diseases, thus elucidating the diseases.  
                                                </p>
                                                    <p class="info-text">
                                                      We welcome suggestions from researchers in academia and industry for future improvements, up gradation and modification of the database.
                                ...
                                <div class="row">
                                    <div class="col-xs-12">
                                        <h2 class="info-heading3" >Plants used against the following</h2>
                                ...
                                <div class="row">
                                    <div class="col-lg-12" id="employee1">
                            ...
                            <?php $alpha=range('A','Z'); ?>
                             <nav class="navbar navbar-expand-sm " style="background-color:green; margin-left:60px;">
                                 <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                                    <span style="background-color:yellow; width:50px;" class="navbar-toggler-icon">A-Z</span>
                                </button>
                                    ...
                                    <ul class="navbar-nav ">
                                        <li class="nav-item ">
                                            <?php foreach($alpha as $value)
                                                    { ?>
                                                        <a class="a" style="color:yellow;text-decoration:none;font-weight:650;" id="an" href="<?php echo "A.php?alphas=$value"; ?>" ><?php echo $value;echo str_repeat("&nbsp;", 5); } ?></a>
                                        </li>
                                    </ul>
                                </div>
                            </nav>
                               ...
                               <div class="container z-depth-3 " id="a">
                                   ...
                                   <div class="row">
					                   <div class="col-sm-12 col-xs-12 col-md-12 col-lg-12">
                                           <h4 class="adsearch-heading1">Search by Plants name..</h4>
		...
		<form method="post" action="email.php" id="request-form">
		...
		<input type="text" onblur="content(this.value)" class="form-control" id="plantname" placeholder="Plant's Name" name="plantsName" required>
			...
			<div class="form-group"> 
			<label for="geographic" class="control-label">Geographic Location</label>
			<input type="text"  placeholder="Geographic Location" class="form-control" id="geographic" name="geographic" required>
				<span id="span7" class="text-danger"></span>
		...
		<input type="text" id="image" name="img" placeholder="url for images" class="form-control">
            ...
            <button type="submit" class="btn btn-danger col-xs-12"name="submit">REQUEST</button>
			</div> 
                                ...
                                <div class="container" id="reference-container">
                                    ...
                                    <div class="row">
                                        ...
                                        <li>Kastenholz, B., & Garfin, D. E. (2009). Medicinal plants: a natural chaperones source for treating neurological disorders. Protein and peptide letters, 16(2), 116-120.</li>	
                                                 <li align="justify"><a class="link" href="http://www.planetayurveda.com/library/schizophrenia">http://www.planetayurveda.com/library/schizophrenia</a></li>
                                                 <li align="justify"><a class="link" href="https://www.naturalalternativeremedy.com/12-natural-remedies-for-schizophrenia/">https://www.naturalalternativeremedy.com/12-natural-remedies-for-schizophrenia/</a></li>	
        ...
        <div class="container" >
            ...
            <div class="row" id="firstnavbar">
                <div class="col-xl-12 ">
                    <ul class="nav nav-pills down1 mb-1"  id="pills-tab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link down" id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab" aria-controls="pills-home" aria-selected="true" style="border-left-style:solid;border-left-width:1px;">HOME</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link down" id="pills-browse-tab" data-toggle="pill" href="#pills-browse" role="tab" aria-controls="pills-browse" aria-selected="false" style="border-left-style:solid;border-left-width:1px;">BROWSE</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link down" id="pills-advancedsearch-tab" data-toggle="pill" href="#pills-advancedsearch" role="tab" aria-controls="pills-advancedsearch" aria-selected="false" style="border-left-style:solid;border-left-width:1px;">ADVANCED SEARCH</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link down" id="pills-request-tab" data-toggle="pill" href="#pills-request" role="tab" aria-controls="pills-request" aria-selected="false" style="border-left-style:solid;border-left-width:1px;">REQUEST</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link down" id="pills-references-tab" data-toggle="pill" href="#pills-references" role="tab" aria-controls="pills-references" aria-selected="false" style="border-left-style:solid;border-left-width:1px;">REFERENCES</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link down" id="pills-cite-tab" data-toggle="pill" href="#pills-cite" role="tab" aria-controls="pills-cite" aria-selected="false" style="border-left-style:solid;border-right-style:solid;border-left-width:1px;border-right-width:1px;" >CITE</a>
                        </li>
						<li class="nav-item">
                            <a href="adminlogin.php" class="nav-link down" style=";border-right-style:solid;border-right-width:1px;" >LOGIN </a>
                        </li>
